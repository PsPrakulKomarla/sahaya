...
government-service adapter layer by depending on these abstract ports. The API
layer provides concrete adapters.
"""
...
class ApprovalPort(ABC):
    ...
    @abstractmethod
    async def is_approved(self, approval_id: UUID) -> bool: ...
