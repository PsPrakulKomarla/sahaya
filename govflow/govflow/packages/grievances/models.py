...
These models are transport- and storage-agnostic. The SQLAlchemy ``Grievance``
entity (in ``app.models.grievance``) is adapted to this aggregate by the API
layer. Internal representations stay language-independent; localized strings
are produced only at the presentation boundary.
"""
